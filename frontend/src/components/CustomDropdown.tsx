              ...
              {options.map((option) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full flex items-center justify-between px-3 py-2 text-xs rounded-xl transition-all select-none text-left transform-gpu ${
                      isDisabled
                        ? 'opacity-40 cursor-not-allowed bg-transparent text-[#a1a1a6]'
                        : isSelected
                        ? 'bg-[#0066cc]/10 text-[#0066cc] font-bold cursor-pointer'
                        : 'text-[#1d1d1f] hover:bg-[#f5f5f7] font-medium cursor-pointer'
                    }`}
                    role="option"
